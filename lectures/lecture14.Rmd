...
title: "Relational Data: Keys, Joins, and Multi-Table Operations"
output: 
  learnr::tutorial:
    progressive: true
    css: css/lecture.css
...
Recall that we limited ourselves to 5 airport codes. Notice the number of rows in this join:
...
To avoid lots of redundant typing, if two tables have a set of columns in common, those will automatically be used to join (**natural join**)
...
* Next time: strings and regular expressions
