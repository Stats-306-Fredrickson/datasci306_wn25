...
subtitle: "Tables, Loading Data, and Dates"
output:
  learnr::tutorial:
    progressive: true
    css: css/lecture.css
...
>* `tibble`: vectors of different types, more features
...
`data.frame`s can be a little surprising with names. Always give them explicitly.
